...
USER_N = "USER VARCHAR(255) NOT NULL UNIQUE"
...
USERFIELDS = [ID, USER_N, FIRST, LAST, EMAIL,
...
USER_N2 = "USER VARCHAR(255) NOT NULL"
ORDERFIELDS = [USER_N2, ITEM_NAME, QUANTITY]
...
TABLES = [USER_TABLE, ADDRESS_TABLE,
          DISCOUNT_TABLE, SALE_TABLE, ITEM_TABLE, ORDER_TABLE]

FELDS = [USERFIELDS, ADDRESSFIELDS, DISCOUNTFIELDS, SALEFIELDS, ITEMFIELDS, ORDERFIELDS]
